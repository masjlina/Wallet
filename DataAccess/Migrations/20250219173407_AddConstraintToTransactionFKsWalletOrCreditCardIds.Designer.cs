...
namespace DataAccess.Migrations
{
    ...
    [Migration("20250219173407_AddConstraintToTransactionFKsWalletOrCreditCardIds")]
    partial class AddConstraintToTransactionFKsWalletOrCreditCardIds
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataAccess.Entities.Wallet", b =>
                {
                    b.HasOne("DataAccess.Entities.ApplicationUser", "ApplicationUser")
                        .WithOne("Wallet")
                        .HasForeignKey("DataAccess.Entities.Wallet", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
